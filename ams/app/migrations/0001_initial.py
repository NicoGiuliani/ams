# Generated by Django 4.2 on 2023-05-08 22:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feeding_schedule', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.feedingschedule')),
            ],
            options={
